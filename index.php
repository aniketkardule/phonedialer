...
<html lang="en">
    <head>
        ...
        <script src="https://use.fontawesome.com/5907deaed2.js"></script>
        ...
        <div class="dialer">
            ...
            <table>
                ...
                <tr class="dial-signs">
                    ...
                    <td class="dial1"><p class="dial-no signs"><i class="fa fa-phone" aria-hidden="true"></i></p></td>
                    <td><p id="dial" class=" dial-no signs"><i class="fa fa-long-arrow-left" aria-hidden="true"></i></p></p></td>
                </tr>
            </table>
        </div>
